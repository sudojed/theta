...
public abstract class Funcao {
    ...
    public void setDominio(List<Intervalo> dominio) {
    ...
    public void setZeros(List<Double> zeros) {
        this.zeros = zeros;
    }
    ...
    public void setParidade(ParidadeEnum paridade) {
    ...
    public void setVariacaoSinal(Map<Intervalo, String> variacaoSinal) {
    ...
    public void setMonotonia(Map<Intervalo, String> monotonia) {
    ...
    public void setConcavidade(Map<Intervalo, String> concavidade) {
    ...
    public void setContradominio(List<Intervalo> contradominio) {
